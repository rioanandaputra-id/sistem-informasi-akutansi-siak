...
class KegiatanMonitoringController extends Controller
{
    ...
    {
        $rba_a_verif_rba = ($this->request->rba_a_verif_rba) ? " AND  rba.a_verif_rba = '".$this->request->rba_a_verif_rba."'" : "";
    ...
    public function apiUpdate()
    {
        try {
            ...
            $id_kegiatan_divisi = $this->request->id_kegiatan_divisi;
            $catatan_verif_rba = $this->request->catatan_verif_rba;
            ...
            $this->mRba->whereIn('id_kegiatan_divisi', $id_kegiatan_divisi)->update([
                'catatan_verif_rba' => $catatan_verif_rba,
    ...
    public function viewGetAll()
    {
        ...
        $divisi = DB::select("
            ...
            ORDER BY
                div.nm_divisi ASC
        ");
        return view('pages._kepalaUud.kegiatanMonitoring.viewGetAll', compact('info', 'kegiatan', 'divisi'));
    }
    ...
    public function viewDetail()
    {
        ...
        return view('pages._kepalaUud.kegiatanMonitoring.viewDetail', compact('info', 'kegiatan', 'detailRba', 'akun', 'laksKegiatan'));
    }
    ...
    public function viewGetAllLaksanaDetail()
    {
        ...
        return view('pages._kepalaUud.kegiatanMonitoring.viewGetAllLaksanaDetail', compact('info', 'kegiatan', 'detailLaks', 'akun'));
    }
}
