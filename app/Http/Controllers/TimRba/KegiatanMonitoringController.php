...
class KegiatanMonitoringController extends Controller
{
    ...
    public function viewDetail()
    {
        ...
        return view('pages._timRba.kegiatanMonitoring.viewDetail', compact('info', 'kegiatan', 'detailRba', 'akun', 'laksKegiatan'));
    }
    ...
    public function viewGetAllLaksanaDetail()
    {
        ...
        return view('pages._timRba.kegiatanMonitoring.viewGetAllLaksanaDetail', compact('info', 'kegiatan', 'detailLaks', 'akun'));
    }
