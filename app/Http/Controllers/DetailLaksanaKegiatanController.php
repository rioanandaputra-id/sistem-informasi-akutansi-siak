...
class DetailLaksanaKegiatanController extends Controller
{
    private $request;
    private $mDetailLaksanaKegiatanController;

    public function __construct()
    {
        $this->request = app(Request::class);
        $this->mDetailLaksanaKegiatanController = app(DetailLaksanaKegiatan::class);
    }
    ...
    public function apiCreate($noApi = null)
    {
        try {
            ...
            $this->mDetailLaksanaKegiatanController->create([
    ...
    public function apiUpdate($noApi = null)
    {
        try {
            ...
            $this->mDetailLaksanaKegiatanController->where('id_kegiatan_divisi', $id_kegiatan_divisi)->update([
                'id_divisi' => $id_divisi,
                'id_kegiatan' => $id_kegiatan,
                'a_verif_rba' => $a_verif_rba,
                'id_verif_rba' => $id_verif_rba,
    ...
    public function apiDelete($noApi = null, $idLaksanaKegiatan = null)
    {
        try {
            ...
            $this->mDetailLaksanaKegiatanController->whereIn('id_kegiatan_divisi', $id_kegiatan_divisi)->update([
