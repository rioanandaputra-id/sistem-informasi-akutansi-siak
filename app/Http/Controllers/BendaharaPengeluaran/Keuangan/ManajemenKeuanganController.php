...
namespace App\Http\Controllers\BendaharaPengeluaran\Keuangan;
...
class ManajemenKeuanganController extends Controller
{
    ...
    public function perencanaanViewGetAll()
    {
        ...
        return view('pages._bendaharaPengeluaran._keuangan.manajemenKeuangan.perencanaan.viewGetAll', compact('info','divisi'));
    }
    ...
    public function penganggaranPendapatanViewGetAll()
    {
        ...
        ");
        return view('pages._bendaharaPengeluaran._keuangan.manajemenKeuangan.penganggaran.pendapatan.viewGetAll', compact('info'));
    }
    ...
    public function penganggaranPengeluaranViewGetAll()
    {
        ...
        $akun = \DB::SELECT("
            ...
            WHERE
                ...
                AND akn.deleted_at IS NULL
        ");
        return view('pages._bendaharaPengeluaran._keuangan.manajemenKeuangan.penganggaran.pengeluaran.viewGetAll', compact('info'));
    }
    ...
    public function penatausahaanViewGetAll()
    {
        ...
        return view('pages._bendaharaPengeluaran._keuangan.manajemenKeuangan.penatausahaan.viewGetAll', compact('info'));
    }
    ...
    public function pelaporanViewGetAll()
    {
        ...
        return view('pages._bendaharaPengeluaran._keuangan.manajemenKeuangan.pelaporan.viewGetAll', compact('info'));
    }
