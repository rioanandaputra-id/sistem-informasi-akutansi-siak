...
{   
    ...
    public function viewGetAll()
    {
        ...
        ");
        return view('pages._bendaharaPenerimaan.spj.viewGetAll', compact('info','kegiatan'));
    }
    ...
    public function viewDetail()
    {
        ...
        return view('pages._bendaharaPenerimaan.spj.viewDetail', compact('info', 'bku', 'detLaks', 'akun', 'spj'));
    }
}
