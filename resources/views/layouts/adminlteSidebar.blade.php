        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @can('kepalawilayah')
                    ...
                    </li></li><li class="nav-header">MANAJEMEN KEUANGAN</li>
                    <li class="nav-item">
                        <a href="{{ route('kepalawilayah.ManajemenKeuangan.perencanaan.viewGetAll') }}"
                    ...
                    <li class="nav-item {{ $info['site_active'] == 'Penganggaran' || $info['site_active'] == 'PenganggaranPendapatan' || $info['site_active'] == 'PenganggaranPengeluaran' ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('kepalawilayah.ManajemenKeuangan.penganggaranPendapatan.viewGetAll') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('kepalawilayah.ManajemenKeuangan.penganggaranPengeluaran.viewGetAll') }}"
                    ...
                    <li class="nav-item {{ in_array($info['site_active'], ['PelaporanRba21','PelaporanRba211']) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('kepalawilayah.ManajemenKeuangan.pelaporan.Rba21.viewGetAll') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('kepalawilayah.ManajemenKeuangan.pelaporan.Rba211.viewGetAll') }}"
                ...
                @can('kepalauud')
                    ...
                    <li class="nav-item {{ in_array($info['site_active'], ['PelaporanRba21','PelaporanRba211','PelaporanSpj21','PelaporanSpj211']) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('kepalauud.ManajemenKeuangan.pelaporan.Rba211.viewGetAll') }}"
                                    class="nav-link {{ $info['site_active'] == 'PelaporanRba211' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>RBA 2.1.1</p>
                                </a>
                ...
                @can('kepalabagian')
                    ...
                    <li class="nav-item {{ in_array($info['site_active'], ['PelaporanRba21','PelaporanRba211','PelaporanSpj211']) ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('kepalabagian.ManajemenKeuangan.pelaporan.Rba211.viewGetAll') }}"
                                    class="nav-link {{ $info['site_active'] == 'PelaporanRba211' ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>RBA 2.1.1</p>
                                </a>
                ...
                @can('bendpengeluaran')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('bendaharapengeluaran.SPJKegiatanRutin.viewGetAll') }}"
                            class="nav-link {{ $info['site_active'] == 'SPJKegiatanRutin' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-list"></i>
