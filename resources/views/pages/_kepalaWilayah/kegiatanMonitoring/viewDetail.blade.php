                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            @foreach ($kegiatan as $kgt)
                                @php
                                    $lockedBtnVerif = $kgt->rba_tgl_verif_wilayah != null ? 'disabled' : '';
                                @endphp
                                <table>
                                    <tbody>
                                        <tr>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item mb-2"
                                                            href="{{ route('kepalawilayah.KegiatanMonitoring.viewGetAllLaksanaDetail') }}?id_laksana_kegiatan={{ $lkgt->id_laksana_kegiatan }}">Detail
            ...
            $("#btnVerifMdl").click(function() {
                $.ajax({
                    ...
                    data: {
                        ...
                        a_verif_wilayah: $('#a_verif_rbaVerifMdl').val(),
                        catatan_verif_wilayah: $('#catatanVerifMdl').val(),
                    },
                    beforeSend: function() {
