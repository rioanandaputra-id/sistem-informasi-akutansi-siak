            ...
            <div class="card card-info" id="SectionCardUnitOrga">
                ...
                <div class="card-body">
                    <div class="bg-light p-3">
                        <form action="{{ route('kepalabagian.KegiatanRutin.apiCreate') }}" method="POST">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="a_aktif">Periode: <i class="text-danger">*</i></label>
                                    <input type="text" value="{{ date('Y') }}" class="form-control @error('periode') is-invalid @enderror" value="{{ old('periode') }}" id="periode" name="periode">
                                    @error('periode')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="card-footer mt-4">
                                ...
                                <a href="{{ route('kepalabagian.Kegiatan.viewGetAll') }}" type="button" class="btn noborder btn-info"><i
