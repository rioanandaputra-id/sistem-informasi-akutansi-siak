            ...
            <div class="card card-info" id="SectionCardUnitOrga">
                ...
                <div class="card-body">
                    <div class="bg-light p-3">
                        <form action="{{ route('kepalabagian.kegiatanPendapatan.apiCreate') }}" method="POST">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="card-footer mt-4">
                                ...
                                <a href="{{ route('kepalabagian.kegiatanPendapatan.viewGetAll') }}" type="button" class="btn noborder btn-info"><i
