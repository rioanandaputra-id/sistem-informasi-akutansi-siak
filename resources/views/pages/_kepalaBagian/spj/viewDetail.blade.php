...
<script>
    $(document).ready(function() {
        ...
        $("#btnupdateDetailSpjMdl").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('kepalabagian.SPJKegiatan.apiUpdateDetailSpj') }}",
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function() {
        ...
        $("#deleteDetailSpj").click(function() {
            ...
            Swal.fire({
                ...
                if (willDelete.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{!! route('kepalabagian.SPJKegiatan.apiDeleteDetailSpj') !!}",
                        data: {
                            _token: "{!! csrf_token() !!}",
        ...
        $("#locked").click(function() {
            ...
            Swal.fire({
                ...
                if (willDelete.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{!! route('kepalabagian.SPJKegiatan.apiUpdate') !!}",
                        data: {
                            _token: "{!! csrf_token() !!}",
                            id_spj: "{!! $idSpj !!}",
                        }
