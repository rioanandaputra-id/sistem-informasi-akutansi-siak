    ...
    <script>
        ...
        function tbBku() {
            $('#tbBku').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: '{{ route('bendaharapenerimaan.SPJKegiatan.apiGetAll') }}',
                    type: 'GET',
                    data: {
                ...
                columns: [
                {
                    ...
                    title: 'Pengajuan',
                    render: function(data, type, row) {
                        return `<a href="{!! route('bendaharapenerimaan.SPJKegiatan.viewDetail') !!}?id_laksana_kegiatan=${row.id_laksana_kegiatan}">Pelaksanaan Ke-${row.urutan_laksana_kegiatan}</a>`;
                    }
                },
                {
                    data: 'status',
