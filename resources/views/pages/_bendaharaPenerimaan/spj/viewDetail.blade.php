...
<script>
    $(document).ready(function() {
        ...
        $("#btnaddDetailSpjMdl").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('bendaharapenerimaan.SPJKegiatan.apiCreateDetailSpj') }}",
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function() {
        ...
        $("#btnupdateDetailSpjMdl").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('bendaharapenerimaan.SPJKegiatan.apiUpdateDetailSpj') }}",
                data: formData,
                processData: false,
                contentType: false,
                beforeSend: function() {
        ...
        $("#deleteDetailSpj").click(function() {
            ...
            Swal.fire({
                ...
                if (willDelete.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{!! route('bendaharapenerimaan.SPJKegiatan.apiDeleteDetailSpj') !!}",
                        data: {
                            _token: "{!! csrf_token() !!}",
        ...
        $("#locked").click(function() {
            ...
            Swal.fire({
                ...
                if (willDelete.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{!! route('bendaharapenerimaan.SPJKegiatan.apiUpdate') !!}",
                        data: {
                            _token: "{!! csrf_token() !!}",
                            id_spj: "{!! $idSpj !!}",
                        }
