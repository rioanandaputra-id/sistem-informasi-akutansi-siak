            ...
            <div class="card card-info" id="SectionCardUnitOrga">
                ...
                <div class="card-body">
                    <div class="bg-light p-3">
                        <form action="{{ route('bendaharapendapatan.kegiatanPendapatan.apiCreate') }}" method="POST">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="card-footer mt-4">
                                ...
                                <a href="{{ route('bendaharapendapatan.kegiatanPendapatan.viewGetAll') }}" type="button" class="btn noborder btn-info"><i
