    ...
    <script>
        ...
        function tbkegiatandivisi() {
            $('#tbkegiatandivisi').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: '{{ route('bendaharapengeluaran.KegiatanRutinPelaksana.apiGetAll') }}',
                    type: 'GET',
                    data: {
                ...
                columns: [{
                        ...
                        title: 'Kegiatan',
                        render: function(data, type, row) {
                            return `<a href="{{ route('bendaharapengeluaran.KegiatanRutinPelaksana.viewDetail') }}?id_laksana_kegiatan=${row.id_laksana_kegiatan}">Pelaksanaan Ke-${row.urutan_laksana_kegiatan}</a>,<br>${row.nm_kegiatan},<br>[${row.periode_program}] ${row.nm_program}`;
                        }
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `${row.waktu_pelaksanaan} -<br>${row.waktu_selesai},<br>${row.nm_divisi}`;
                        }
                    },
                    {
                        data: 'nm_divisi',
                        ...
                        title: 'Status',
                        render: function(data, type, row) {
                            return `${row.a_verif_kabag_keuangan}`;
                        }
                    },
                ],
            });
