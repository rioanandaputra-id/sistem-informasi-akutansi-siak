    ...
    <div class="row">
        <div class="col">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{ \App\Models\LaksanaKegiatan::whereNull('deleted_at')->where('a_verif_kabag_keuangan', 2)->count() }}</h3>
        ...
        <div class="col">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Pendapatan & Pengeluaran Diverifikasi Tahun {{ date('Y') }}</h3>
                </div>
                <div class="card-body">
                    <div class="row">
