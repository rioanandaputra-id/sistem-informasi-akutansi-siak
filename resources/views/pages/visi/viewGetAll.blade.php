        ...
        <div class="col">
            <div class="card card-info">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col">
                            <div class="float-left">
                                <a href="{{ route('visi.viewCreate') }}" type="button" class="btn btn-info">
                    ...
                    <div class="row">
                        <div class="col">
                            <table class="table table-striped teble-bordered" id="tbVisi" style="width: 100%">
