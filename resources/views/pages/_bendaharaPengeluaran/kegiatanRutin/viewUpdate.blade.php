            ...
            <div class="card card-info" id="SectionCardUnitOrga">
                ...
                <div class="card-body">
                    <div class="bg-light p-3">
                        <form action="{{ route('bendaharapengeluaran.kegiatanRutin.apiUpdate') }}" method="POST">
                            @csrf
                            @foreach ($kegiatanRutin as $kgt)
                                <div class="form-row">
                            ...
                            <div class="card-footer mt-4">
                                ...
                                <a href="{{ route('bendaharapengeluaran.kegiatanRutin.viewGetAll') }}" type="button"
