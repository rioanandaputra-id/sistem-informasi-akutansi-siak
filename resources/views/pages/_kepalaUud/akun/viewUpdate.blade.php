                        ...
                        <form action="{{ route('kepalauud.master.akun.apiUpdate') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('sub_elemen') is-invalid @enderror" value="{{ $akn->sub_elemen ?? old('sub_elemen') }}" id="sub_elemen" name="sub_elemen" maxlength="2" placeholder="00" required>
                                    @error('sub_elemen')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
