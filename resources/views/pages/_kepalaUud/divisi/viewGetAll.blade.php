                    ...
                    <div class="row mb-2">
                        <div class="col">
                            <div class="float-left">
                                <a href="{{ route('kepalauud.master.divisi.viewCreate') }}" type="button" class="btn btn-info noborder">
    ...
    <script>
        $(document).ready(function() {
            $('#tbDivisi').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: '{{ route('kepalauud.master.divisi.apiGetAll') }}',
                    type: 'GET'
                },
                columns: [{
                    data: 'id_divisi',
                    ...
                    render: function(data, type, row, meta) {
                        return `<a href="{!! route('kepalauud.master.divisi.viewUpdate') !!}?id_divisi=${row.id_divisi}">${data}</a>`;
                    }
                },]
            });
            ...
            $("#delete").click(function() {
                ...
                Swal.fire({
                    ...
                    if (willDelete.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: '{{ route('kepalauud.master.divisi.apiDelete') }}',
                            data: {
                                _token: "{!! csrf_token() !!}",
                                no_api: 0,
                                id_divisi: getId()
