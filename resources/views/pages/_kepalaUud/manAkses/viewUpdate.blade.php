            ...
            <div class="card card-info" id="SectionCardUnitOrga">
                ...
                <div class="card-body">
                    <div class="bg-light p-3">
                        <form action="{{ route('kepalauud.master.manAkses.apiUpdate') }}" method="POST">
                            @csrf
                            @foreach ($user as $usr)
                                <div class="form-row">
                                        ...
                                        <select name="id_divisi" id="id_divisi"
                                            ...
                                            @foreach ($divisi as $di)
                                                <option value="{{ $di->id_divisi }}"
                                                    {{ old('id_divisi') == $di->id_divisi || $usr->id_divisi == $di->id_divisi ? 'selected' : '' }}>
                                                    {{ $di->nm_divisi }}</option>
                                            @endforeach
                                        </select>
                                        @error('id_divisi')
                                        ...
                                        <select name="id_role" id="id_role"
                                            ...
                                            @foreach ($role as $rol)
                                                <option value="{{ $rol->id_role }}"
                                                    {{ old('id_role') == $rol->id_role || $usr->id_role == $rol->id_role ? 'selected' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('full_name') is-invalid @enderror"
                                            value="{{ old('full_name') ?? $usr->full_name }}" id="full_name" name="full_name">
                                        @error('full_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="gender" id="gender"
                                            ...
                                            <option value=""></option>
                                            <option value="L" {{ old('gender') == 'L' || $usr->gender == 'L' ? 'selected' : '' }}>Laki-laki
                                            </option>
                                            <option value="P" {{ old('gender') == 'P' || $usr->gender == 'P' ? 'selected' : '' }}>Perempuan
                                            </option>
                                        </select>
                                        @error('gender')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="username" class="form-control @error('username') is-invalid @enderror"
                                            value="{{ old('username') ?? $usr->username }}" id="username" name="username">
                                        @error('username')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="phone" class="form-control @error('phone') is-invalid @enderror"
                                            value="{{ old('phone') ?? $usr->phone }}" id="phone" name="phone">
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            value="{{ old('email') ?? $usr->email }}" id="email" name="email">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror">{{ old('address') ?? $usr->address }}</textarea>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select name="a_active" id="a_active"
                                            class="form-control @error('a_active') is-invalid @enderror">
                                            <option value=""></option>
                                            <option value="1" {{ old('a_active') == '1' || $usr->a_active == '1' ? 'selected' : '' }}>Aktif
                                            </option>
                                            <option value="0" {{ old('a_active') == '0' || $usr->a_active == '0' ? 'selected' : '' }}>Non
                                                Aktif</option>
                                        </select>
                                        @error('a_active')
                                            <span class="invalid-feedback" role="alert">
                            ...
                            <div class="card-footer mt-4">
                                <button type="submit" class="btn noborder btn-info mr-2"><i class="fas fa-edit"></i>
                                    Ubah Data</button>
